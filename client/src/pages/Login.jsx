          ...
          >
            ...
            <div>
              ...
              <input
                ...
                className="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
                required
                onChange={(e) => setLogin({ ...login, passwordd: e.target.value })}
              />
            </div>
            <div className="flex flex-row gap-2 justify-between items-center ">
              ...
              <Link to="/register">
                <button className="bg-gray-200 text-gray-700 py-2 rounded-md hover:bg-gray-300 focus:outline-none px-4">
                  Buat Akun
                </button>
              </Link>
            </div>
